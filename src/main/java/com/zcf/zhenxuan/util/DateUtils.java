...
public class DateUtils {
    ...
    /**
     * 格式化日期     SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd"); 自定义格式
     * @param date
     * @param format
     * @return
     */
    ...
    /**
     * 格式化日期       和 SimpleDateFormat格式日期一样
    ...
    /**
     * 返回一天后的时间 2018-08-09  （今天是2018-08-08  参数是String）
     * @param date
     * @return
     */
    ...
    /**
     * 返回一天后的时间 2018-08-09  （今天是2018-08-08 参数是Date）
     * @param date
     * @return
     */
